      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid gap-8 md:grid-cols-[0.85fr_1.15fr]">
          <div className="max-w-sm text-sm leading-6 text-gray-500">
            ...
            为 AI 账号卖家聚合公开货源、官方价格与经营信息。本站不收款、不担保，采购、交付和售后以原平台规则为准。
          </div>
          <div className="grid grid-cols-2 gap-8"><div><strong className="text-sm text-gray-950">卖家找货</strong><div className="mt-3 grid gap-2 text-sm text-gray-500"><Link href="/card-products" className="hover:text-emerald-700">订阅货源</Link><Link href="/card-products/all" className="hover:text-emerald-700">全部报价</Link><Link href="/official-prices" className="hover:text-emerald-700">官方成本</Link><Link href="/channels" className="hover:text-emerald-700">渠道商目录</Link></div></div><div><strong className="text-sm text-gray-950">商家经营</strong><div className="mt-3 grid gap-2 text-sm text-gray-500"><Link href="/opportunities/latest" className="hover:text-emerald-700">账号商机日报</Link><Link href="/opportunities" className="hover:text-emerald-700">实时商机台</Link><Link href="/profit-calculator" className="hover:text-emerald-700">利润计算器</Link><Link href="/wholesale" className="hover:text-emerald-700">批发供需</Link><Link href="/commercial" className="hover:text-emerald-700">企业客户经营</Link></div></div></div>
        </div>
