  ...
  return (
    <main className="market-page py-10 sm:py-16">
      <div className="market-shell">
        <header className="mx-auto max-w-3xl text-center"><span className="radar-kicker">Wholesale matching</span><h1 className="market-display mt-3 text-4xl sm:text-6xl">批量采购与货源合作</h1><p className="mt-5 text-base leading-8 text-gray-600">把“我要采购”和“我能供货”分成两条清晰路径。平台提供公开信息与核验工具，不代收款、不参与第三方履约。</p></header>

        <section className="mt-10 grid gap-4 lg:grid-cols-2">
          <article className="market-card flex flex-col p-6 sm:p-8"><span className="flex h-11 w-11 items-center justify-center rounded-full bg-emerald-50 text-emerald-800"><PackageSearch className="h-5 w-5" /></span><span className="mt-7 text-xs font-bold text-emerald-700">我是买家 / 卖家补货</span><h2 className="market-display mt-2 text-3xl">先找货，再谈批量采购</h2><p className="mt-4 flex-1 text-sm leading-7 text-gray-600">从标准商品查看当前可售报价和渠道覆盖；确认规格后计算目标售价、退款与售后成本。需要人工采购服务时再进入爱窝啦主站。</p><div className="mt-6 flex flex-wrap gap-2"><Link href="/card-products" className="market-pill market-pill--primary">查看可售货源<ArrowRight className="h-4 w-4" /></Link><a href={STORE_URL} target="_blank" rel="noopener" className="market-pill market-pill--secondary">联系主站采购</a></div></article>
